...
(* OASIS_START *)
(* DO NOT EDIT (digest: 967abafc4bb756b9d400f0a625f62e7c) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$ppx_hardcaml_test", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/xguerin/ppx_hardcaml";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "PPX plugin for the OCAML OPAM hardcaml package."
              ];
          tags = [];
          categories = [];
          files_ab = ["META.ab"];
            ...
            [
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/xguerin/ppx_hardcaml.git";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_hardcaml.ml"});
               Executable
                 ({
                     cs_name = "ppx_hardcaml_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_byteopt =
                        [
                           (OASISExpr.EBool true,
                             ["-ppx"; "../_build/src/ppx_hardcaml.native"])
                        ];
                      bs_nativeopt =
                        [
                           (OASISExpr.EBool true,
                   ...
                   {exec_custom = false; exec_main_is = "PpxHardcamlTest.ml"});
               Test
                 ({
                     cs_name = "ppx_hardcaml_test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "ppx_hardcaml_test"
                        ]
                   })
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\200\210i\152\130+.\014\127\005=z\026\156a\165";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
